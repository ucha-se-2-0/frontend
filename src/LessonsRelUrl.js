...
for(var header in lessonUrl)
{
    lessonHeader[lessonUrl[header]] = header;
}

function GetUrl (lessonHeader)
{
    return lessonUrl[lessonHeader];
}

function GetHeader (url)
{
    var res = url.match(/\/[^/]+/g);
    return lessonHeader[res[res.length - 1].slice(1)];
}

export { GetUrl, GetHeader }
